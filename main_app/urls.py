...
from .views import send_student_result  # ✅ Correct import
from .views import lost_and_found
from .views import delete_item, update_description
from .views import student_payment
from .hod_views import  delete_staff_leave
from .hod_views import  delete_student_leave
from .hod_views import  delete_feedback , delete_student_feedback
from .views import create_order, verify_payment, admin_payment_dashboard
...
urlpatterns = [
    ...
    path("subject/edit/<int:subject_id>",
     ...
     path('delete-staff-leave/', delete_staff_leave, name="delete_staff_leave"), 
     path("delete-student-leave/<int:leave_id>/", delete_student_leave, name='delete_leave'),

     path("delete-feedback/<int:feedback_id>/", delete_feedback, name="delete_feedback"),
     path("delete-student-feedback/<int:feedback_id>/", delete_student_feedback, name="delete_student_feedback"),
     path('admin/payments/', admin_payment_dashboard, name='admin_payment_dashboard'),


# lost and found :
    path("lost-and-found/", lost_and_found, name="lost_and_found"),
     path('delete-item/<int:item_id>/', delete_item, name='delete_item'),
    path('update-description/', update_description, name='update_description'),
    ...
    path('staff/result/fetch/', staff_views.fetch_student_result,
      ...
      path('send_student_result/', send_student_result, name='send_student_result'),
    ...
    path('student/view/result/', student_views.student_view_result,
     ...
     path('payment/', student_payment, name='student_payment'),
